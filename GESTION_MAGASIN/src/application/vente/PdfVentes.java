...
public class PdfVentes {
	...
	public  void exportProductsToPdf(String pathFileModel, String pathFileResult,     ObservableList<Vente> products) {
        ...
        try {
            ...
            int i=0;
           for(Vente produit :products) {
 
                if (produit != null) {
                    long ref = produit.getId();
                    long refc = produit.getClientId();
                    long refp = produit.getProduitId();
                    int qte = produit.getQuantite();
                    double prix = produit.getMontant();
                    Date d=produit.getDateVente();
